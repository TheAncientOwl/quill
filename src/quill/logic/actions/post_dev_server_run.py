...
#
#  @file post_dev_server_run.py
#  @author Alexandru Delegeanu
#  @version 0.1
#  @description Run configured post-server-run commands
#
...
class PostDevServerRun(argparse._StoreTrueAction):
    ...
    def __call__(self, parser, namespace, values, option_string=None):
        ...
        Logger.info("[Running] post-server-run commands")

        project_paths = ProjectPaths()
        project_config = ProjectConfig()

        commands = project_config.get_post_server_run_commands()
        ...
        Logger.info("[Done] post-server-run commands")
